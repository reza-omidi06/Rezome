                ...
                <div class="col-12">
                    <div class="card" style="margin: 1.5rem auto;">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('admin.myteam.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="name_person" class="form-label"><span style="color:#ec0808;">*&nbsp</span> نام  :</label>
                                        <input id="name_person" type="text" name="name_person" class="form-control" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="name_personـen" class="form-label"><span style="color:#ec0808;">*&nbsp</span> نام(لاتین) : </label>
                                        <input id="name_personـen" type="text" name="name_personـen" class="form-control" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="job_person" class="form-label"><span style="color:#ec0808;">*&nbsp</span>موقعیت شغلی : </label>
                                        <input id="job_person" type="text" name="job_person" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse p-3" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input id="social_person_instagram" type="text" name="social_person_instagram" class="form-control" >
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="social_person_linkedin" class="form-label"><span><i class='bx bxl-linkedin' ></i>|</span> linkedin : </label>
                                                    <input id="social_person_linkedin" type="text" name="social_person_linkedin" class="form-control" >
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="social_person_telegram" class="form-label"><span><i class='bx bxl-telegram' ></i>|</span>Telegram : </label>
                                                    <input id="social_person_telegram" type="text" name="social_person_telegram" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="social_person_X" class="form-label"><span ><i class='bx bxl-twitter'></i>|</span> Twitter  :</label>
                                                    <input id="social_person_X" type="text" name="social_person_X" class="form-control" >
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="social_person_facebook" class="form-label"><span><i class='bx bxl-facebook-circle' ></i>|</span>Facebook : </label>
                                                    <input id="social_person_facebook" type="text" name="social_person_facebook" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
