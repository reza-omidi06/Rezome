                ...
                <div class="col-12">
                    <div class="card" style="margin: 1.5rem auto;">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('admin.fecureplan.update')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$edit_fecure->id}}">
                                <div class="row">
                                        ...
                                        <select name="plan_type_id" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                            ...
                                            <optgroup label="پلن">
                                                @foreach($plans as $plan)
                                                    <option value="{{$plan->id}}"  {{$plan->id == $edit_fecure->plan_type_id ? 'selected' : ''}}>
                                                        {{$plan->name_type_fa}}
                                                    </option>
                                                @endforeach
                                            </optgroup>
                                 ...
                                 <div class="row">
                                     <div class="col-md-6 mb-3 ">
                                        <label for="features" class="form-label"><span style="color:#ec0808;">*&nbsp</span> ویژگی  :</label>
                                         <input type="text" name="features" class="form-control" id="tag" data-role="tagsinput" value="{{$edit_fecure->features}}">
                                     </div>
                                 </div>
                                <!--end row-->
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <textarea id="elm1" type="text" name="feature_description" class="form-control">
                                            {!! $edit_fecure->feature_description !!}
