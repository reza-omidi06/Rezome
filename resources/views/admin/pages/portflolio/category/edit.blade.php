                ...
                <div class="col-12">
                    <div class="card" style="margin: 1.5rem auto;">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('admin.portfoliocategory.update')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$edit_portfolio_category->id }}">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="name_portfolio_category" class="form-label"><span style="color:#ec0808;">*&nbsp</span>نام دسته :</label>
                                        <input id="name_portfolio_category" type="text" name="name_portfolio_category" class="form-control" value="{{$edit_portfolio_category->name_portfolio_category}}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="name_en_portfolio_category" class="form-label"><span style="color:#ec0808;">*&nbsp</span>نام دسته (لاتین) : </label>
                                        <input id="name_en_portfolio_category" type="text" name="name_en_portfolio_category" class="form-control" value="{{$edit_portfolio_category->name_en_portfolio_category}}" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-9 mb-3">
                                        ...
                                        <textarea id="elm1" type="text" name="description_portfolio_category" class="form-control">
                                                {!! $edit_portfolio_category->description_portfolio_category !!}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        <img id="showImage" class="rounded avatar-lg" src="{{asset(!empty($edit_portfolio_category->image_portfolio_category) ? $edit_portfolio_category->image_portfolio_category : 'uploads/no_images.jpg')}}" style="border: 1px solid;">
                                    </div>
                                    <div class="col-md-3">
                                    </div>
                                </div>
