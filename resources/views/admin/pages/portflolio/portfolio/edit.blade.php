                            ...
                            <form method="POST" action="{{route('admin.portfolio.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="portfolio_category_id" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true"  >
                                            <option data-select2-id="3">انتخاب</option>
                                            <optgroup label="دسته بندی ها">
                                                @foreach($categorys as $category)
                                                    <option value="{{$category->id}}" {{ $category->id == $edit_portfolio->portfolio_category_id ? 'selected' : '' }}>
                                                        {{$category->name_portfolio_category}}
                                                    </option>
                                                @endforeach
                                            </optgroup>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input  name="portfolio_name" type="text" class="form-control" id="portfolio_name" value="{{$edit_portfolio->portfolio_name}}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="portfolio_client" class="form-label">مشتری</label>
                                        <input  name="portfolio_client" type="text" class="form-control" id="portfolio_client"  value="{{$edit_portfolio->portfolio_client}}">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="portfolio_url" type="url" class="form-control" id="portfolio_url" value="{{$edit_portfolio->portfolio_url}}">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="portfolio_project_date" class="form-label">تاریخ پروژه </label>
                                        <input  name="portfolio_project_date" ype="date" class="form-control" id="portfolio_project_date" value="{{$edit_portfolio->portfolio_project_date}}"  >
                                    </div>
                                </div>
                                <!--end row-->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        <img id="showImage" class="rounded avatar-lg" src="{{asset(!empty($edit_portfolio->portfolio_image) ? $edit_portfolio->portfolio_image : 'uploads/no_images.jpg')}}" style="border: 1px solid;">
                                    </div>
                                    <div class="col-md-3">
                                    </div>
                                </div>
