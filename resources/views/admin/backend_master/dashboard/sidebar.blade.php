<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">صفحه ها </span>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('admin.dynamic.edit')}}" class="menu-link">
                        <div data-i18n="Connections">متن متحرک</div>
                    </a>
                </li>
            </ul>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">درباره ما</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{route('admin.about.manager')}}" class="menu-link">
                        <div data-i18n="Account">مدیریت</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('admin.skill.manager')}}" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{route('admin.service.manage')}}" class="menu-link">
                        <div data-i18n="Account">مدیریت</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{route('admin.rezome.manage')}}" class="menu-link">
                        <div data-i18n="Account">مدیریت</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('admin.rezome.add')}}" class="menu-link">
                        <div data-i18n="Account">افزودن </div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">تنظیمات</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{route('admin.setting.index')}}" class="menu-link">
                        <div data-i18n="Accordion">منو</div>
                    </a>
                </li>
                <li class="menu-item">
